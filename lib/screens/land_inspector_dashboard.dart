...
class _LandInspectorState extends State<LandInspector> {
  ...
  List<Menu> menuItems = [
    ...
    Menu(title: 'Transfer Contract', icon: Icons.transform),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (index == 1)
                  const Text('Total Request Registered',
                      style: TextStyle(fontSize: 20)),
                if (index == 2)
                  const Text('Total Contracts Transfered ',
                      style: TextStyle(fontSize: 20)),
              ],
            ),
          ),
