...
class _AddLandInspectorState extends State<AddLandInspector> {
  ...
  List<Menu> menuItems = [
    Menu(title: ' Add Officer', icon: Icons.person_add),
    Menu(title: ' All Officers', icon: Icons.group),
              ...
              Expanded(
                  child: Center(
                    child: ElevatedButton(
                        ...
                        onPressed: () async {
                          confirmDialog(
                              'Are you sure you want to remove?', context,
                              () async {
